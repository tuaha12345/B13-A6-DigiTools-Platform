...
const Banner = () => {
    return (
        <div className='flex flex-col-reverse md:flex md:flex-row mx-auto px-4 py-8 gap-8 items-center  container w-11/12 my-[60px'>
            <div className='flex flex-col gap-6 justify-center align-center'>
                ...
                <h1 className='font-bold md:text-[72px] text-[32px]'>Supercharge Your<br></br>Digital Workflow</h1>
