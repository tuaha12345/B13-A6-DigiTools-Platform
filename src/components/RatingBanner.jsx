...
const RatingBanner = () => {
    return (
        <div className='bg-linear flex justify-center items-center gap-8 py-12 mt-12'>
            
            <div className='border-r-1 border-white py-5 px-20'>
                <h2 className='text-3xl font-bold text-white text-[40px] '>50K+</h2>
                <p className='text-white text-xl'>Active Users</p>
            </div>
            <div className='border-r-1 border-white  text-center py-5 px-20'>
